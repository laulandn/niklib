...
#ifdef NIK_GUILIB
#ifndef NIK_OPENGL
#ifndef NIK_GUILIB_DRAWING
#error "You must define either NIK_OPENGL or NIK_GUILIB_DRAWING!"
...
{
  debug_msg("nikDrawMesh3D Mesh has "); debug_int(m->getNumFaces()); debug_msg(" faces...\n");
  //nikLockDisplay();
...
void nikDrawScene3D(AScene3D *s)
{
  ...
  debug_msg("nikDrawScene3D Scene has "); debug_int(nshapes); debug_msg(" meshes...\n");
  //nikLockDisplay();
  //nikSetColorLong(0x404040);
  //nikClearFrameBuffer();
